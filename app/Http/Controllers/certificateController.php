...
class certificateController extends Controller
{
    ...
    public function saveCertificate(Request $request)
    {
        ...
        if ($validator->fails()) {
            ...
            $check_email = Certificate::where(['email' => $request->input('email')])->first();
            if($check_email['blocked'] == 1){
                return Redirect::back()->withErrors(['User Blocked contact the admin', 'The Message']);
            }
            if($check_email){
                if($check_email['track'] == $request->input('track')){
                    ...
                    return Redirect::back()->withErrors(['You can\'t change track contact the admin', 'The Message']);
                }
            }
    ...
    private function apidownload( $certificate, $url , $date){
        if ($certificate->certificate_style == 1) {
            $displayCertificate = $this->style1($certificate,$url,$date);
        } else if ($certificate->certificate_style == 2) {
            $displayCertificate = $this->style2($certificate,$url,$date);
        } else if ($certificate->certificate_style == 3) {
            $displayCertificate = $this->style3($certificate,$url,$date);
        } else if ($certificate->certificate_style == 4) {
            $displayCertificate = $this->style4($certificate,$url,$date);
        } else if ($certificate->certificate_style == 5) {
            $displayCertificate = $this->style5($certificate,$url,$date);
        }
    ...
    private function style1($certificate , $url ,$date){
...
/*# sourceMappingURL=index.css.map */
    ...
    <body>
        ...
        return $certificateStyle1;
    }
    private function style2($certificate , $url ,$date){
  ...
  <section class=\"certificate-wrapper\">
    ...
    <main>
      <div class=\"certificate\">
        ...
        return $certificateStyle2;
    }
    private function style3($certificate , $url ,$date){
...
/*# sourceMappingURL=index.css.map */
    ...
    <body>
        ...
        return $certificateStyle3;
    }
    private function style4($certificate , $url ,$date){
...
/*# sourceMappingURL=index.css.map */
    ...
    <body>
        ...
        return $certificateStyle4;
    }
    private function style5($certificate , $url ,$date){
